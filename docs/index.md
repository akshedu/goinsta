...
<p align="center"><img width=100% src="https://raw.githubusercontent.com/akshedu/goinsta/v1/resources/goinsta-image.png"></p>

> Unofficial Instagram API for Golang

[![Build Status](https://travis-ci.org/akshedu/goinsta.svg?branch=master)](https://travis-ci.org/akshedu/goinsta) [![GoDoc](https://godoc.org/github.com/akshedu/goinsta?status.svg)](https://godoc.org/github.com/akshedu/goinsta) [![Go Report Card](https://goreportcard.com/badge/github.com/akshedu/goinsta)](https://goreportcard.com/report/github.com/akshedu/goinsta) [![Gitter chat](https://badges.gitter.im/goinsta/community.png)](https://gitter.im/goinsta/community)
...
`go get -u -v gopkg.in/akshedu/goinsta.v2`
...
- [instagraph](https://github.com/akshedu/instagraph)
...
```
$ go get -u github.com/akshedu/goinsta
```
